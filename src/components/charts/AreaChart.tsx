...
export const AreaChart = memo(function AreaChart({ data, width = 500, height = 200, color = shieldColors.cyan }: AreaChartProps) {
  ...
  const ref = useD3(
    (svg) => {
      ...
      g.append('path').datum(data).attr('d', lineGen).attr('fill', 'none').attr('stroke', color).attr('stroke-width', 2);
